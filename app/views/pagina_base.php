...
<html lang="pt-br">
  ...
  <body> 
    ...
    <div class="base">
          ...
          <div align="right"> <a href="<?php echo URL_BASE . "Login/acessando" ?>"> <input type="button" size="10" value="Voltar" class="btn btn-success"> </a> </div> 


    			<?php $this->load($view, $viewData); //todas as pagina serão carregadas aqui ?>
